...
export const LoadingCard = () => (
  <div className="bg-[#0f1117] rounded-xl p-8 border border-gray-800 animate-pulse">
...
export const LoadingSpinner = ({ size = "md", className = "" }) => {
  ...
  return (
    <div className={`flex justify-center items-center ${className}`}>
      <div
        className={`${sizeClasses[size]} border-4 border-gray-800 border-t-gray-200 rounded-full animate-spin`}
      ></div>
    </div>
  );
};
